...
app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = 'mysql+pymysql://root:Hhuc1115@www.elegantfrog.xyz:3306/frog'
...
class Tag(db.Model):
    ...
    movies = db.relationship("Movie", backref='tag')  # 与电影外键关系关联
...
class Movie(db.Model):
    ...
    tag_id = db.Column(db.Integer, db.ForeignKey('tag.id'))  # 所属标签，关联tag表的id字段
...
if __name__ == "__main__":
    ...
    admin = Admin(
        name="elegantfrog",
        pwd=generate_password_hash("Hhuc1115"),
        is_super=1,
        role_id=1
    )
